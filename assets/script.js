...
var questionsArray = [
{
    question: "What is best practice to place the script element for JavaScrip?",
    imageSrc: "",
    answerChoice: ["A) the bottom of the body", "B) in the head", "C) in a div", "D) in CSS"],
    correctAnswer: 0
}, 
{
    question: "What kind of letter case do you use for JavaScrip?",
    imageSrc: "",
    answerChoice: ["A) all lower", "B) all upper", "C) camel", "D) pascal"],
    correctAnswer: 2
},
{
...
}, 
{
    ...
    imageSrc: "",
    answerChoice: ["A) quotes", "B) curly brackets", "C) square brackets", "D) parentheses"],
    correctAnswer: 3
},
];
